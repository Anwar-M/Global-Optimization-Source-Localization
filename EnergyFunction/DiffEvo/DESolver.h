...
typedef void (DESolver::*StrategyFunction)(int, double*, double*);
...
public:
	...
	virtual bool Solve(int maxGenerations, double min[],double max[]);
...
private:
	void Best1Exp(int candidate, double* min, double* max);
	void Rand1Exp(int candidate, double* min, double* max);
	void RandToBest1Exp(int candidate, double* min, double* max);
	void Best2Exp(int candidate, double* min, double* max);
	void Rand2Exp(int candidate, double* min, double* max);
	void Best1Bin(int candidate, double* min, double* max);
	void Rand1Bin(int candidate, double* min, double* max);
	void RandToBest1Bin(int candidate, double* min, double* max);
	void Best2Bin(int candidate, double* min, double* max);
	void Rand2Bin(int candidate, double* min, double* max);
	void MyCase(int candidate, double* min, double* max);
};
